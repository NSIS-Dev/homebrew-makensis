class MakensisAT30a1 < Formula
  ...
  url "https://downloads.sourceforge.net/project/nsis/NSIS%203/3.0a1/nsis-3.0a1-src.tar.bz2"
  ...
  resource "nsis" do
    url "https://downloads.sourceforge.net/project/nsis/NSIS%203/3.0a1/nsis-3.0a1.zip"
