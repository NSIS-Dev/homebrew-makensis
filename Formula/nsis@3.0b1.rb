class MakensisAT30b1 < Formula
  ...
  url "https://downloads.sourceforge.net/project/nsis/NSIS%203/3.0b1/nsis-3.0b1-src.tar.bz2"
  ...
  resource "nsis" do
    url "https://downloads.sourceforge.net/project/nsis/NSIS%203/3.0b1/nsis-3.0b1.zip"
