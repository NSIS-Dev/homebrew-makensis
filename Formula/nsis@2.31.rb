class MakensisAT231 < Formula
  desc "System to create Windows installers"
  homepage "https://nsis.sourceforge.io/"
  url "https://downloads.sourceforge.net/project/nsis/NSIS%202/2.31/nsis-2.31-src.tar.bz2"
  sha256 "ebe74f550f62a33c5ddc574d689b6f1ed76f1ab7189623ce1f4b33d2b74190a9"
  ...
  resource "nsis" do
    url "https://downloads.sourceforge.net/project/nsis/NSIS%202/2.31/nsis-2.31.zip"
    sha256 "5b14171b9519fdc156c39a137d2da7ff07332f0337cf9e2ba46bd90dd9f244bd"
  end
