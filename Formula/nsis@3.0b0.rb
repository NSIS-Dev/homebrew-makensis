class MakensisAT30b0 < Formula
  ...
  url "https://downloads.sourceforge.net/project/nsis/NSIS%203/3.0b0/nsis-3.0b0-src.tar.bz2"
  ...
  resource "nsis" do
    url "https://downloads.sourceforge.net/project/nsis/NSIS%203/3.0b0/nsis-3.0b0.zip"
