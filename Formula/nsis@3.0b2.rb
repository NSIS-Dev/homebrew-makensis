class MakensisAT30b2 < Formula
  ...
  url "https://downloads.sourceforge.net/project/nsis/NSIS%203/3.0b2/nsis-3.0b2-src.tar.bz2"
  ...
  resource "nsis" do
    url "https://downloads.sourceforge.net/project/nsis/NSIS%203/3.0b2/nsis-3.0b2.zip"
